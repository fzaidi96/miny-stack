...
const app = express(); //instantiated express in the const 'app' (created an instance of express in the const 'app')
...
// endpoint - if the client requests this endpoint '/message' with get we will give them this function
